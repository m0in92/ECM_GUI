.. ECM_GUI documentation master file, created by
   sphinx-quickstart on Thu Sep  7 12:53:47 2023.

Welcome to ECM_GUI's documentation!
===================================
...
Use the following repository link when cloning the GitHub repository:
`link <git@github.com:m0in92/ECM_GUI.git>`_. Furthermore, the project python library
